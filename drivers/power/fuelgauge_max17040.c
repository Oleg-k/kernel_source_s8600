...
static void check_using_max17048(void)
{
	...
	is_max17048 = 2;
#elif defined(CONFIG_MACH_PREVAIL2) || defined(CONFIG_MACH_S8600)  /*max17043, batt=4.2v*/
	is_max17048 = 1;
...
unsigned int fg_read_soc(void)
{
	...
	else if (is_max17048 == 1) /* 4.2V battery, prevail2 & s8600 */
	{ 
...
void fuel_gauge_rcomp(int state)
{
	...
	if (state) 
	{
		...
		rst_cmd[0] = 0x57;
	#elif defined(CONFIG_MACH_PREVAIL2) || defined(CONFIG_MACH_S8600) /*fuelgauge 17043*/
		rst_cmd[0] = 0xB0;
	#else
		rst_cmd[0] = 0xE0;/*0xC0;*/
	#endif
	...
	#if defined(CONFIG_MACH_ICON)
		rst_cmd[0] = 0x57;
	#elif defined(CONFIG_MACH_PREVAIL2) || defined(CONFIG_MACH_S8600)
		rst_cmd[0] = 0xB0;
	#else
		rst_cmd[0] = 0xB0;/*0xC0;*/
	#endif
