...
typedef enum	{
	YDA165_PLAYBACK_SPK,
	YDA165_PLAYBACK_HEADSET,
	YDA165_PLAYBACK_SPK_HEADSET,
	YDA165_CALL_SPK,
	YDA165_CALL_HEADSET,
	YDA165_RADIO_SPK,
	YDA165_RADIO_HEADSET,
	YDA165_SETTING_TYPE_END,
} yda165_setting_type;
...
void yda165_speaker_td_call_onoff(int onoff); /* speaker_call path amp onoff */
void yda165_headset_td_call_onoff(int onoff); /* headset_call path amp onoff */
#endif

void yda165_speaker_headset_onoff(int onoff); /* speaker+headset path amp onoff */
void yda165_headset_fm_onoff(int onoff); /* headset fm path amp onoff */

void yda165_speaker_fm_onoff(int onoff);/* speaker fm path amp onoff */
