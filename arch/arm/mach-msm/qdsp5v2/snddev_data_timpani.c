...
#elif CONFIG_MACH_S8600
#include <mach/qdsp5v2/timpani_profile_7x30_S8600.h>
#else
...
//+for AMR Device
static struct adie_codec_action_unit handset_vcr_tx_48KHz_osr256_actions[] =
	ADIE_HANDSET_VCR_TX_48000_256;
static struct adie_codec_action_unit speaker_vcr_tx_48KHz_osr256_actions[] =
	ADIE_SPEAKER_VCR_TX_48000_256;
static struct adie_codec_action_unit headset_vcr_tx_48KHz_osr256_actions[] =
	ADIE_HEADSET_VCR_TX_48000_256;
//-for AMR Device
...
static struct adie_codec_action_unit speaker_call_tx_48KHz_osr256_actions[] =
 ...
 //+for loopback Device
static struct adie_codec_action_unit loopback_speaker_call_rx_48KHz_osr256_actions[] =
	ADIE_LOOPBACK_SPEAKER_CALL_RX_48000_256;
static struct adie_codec_action_unit loopback_speaker_call_tx_48KHz_osr256_actions[] =
	ADIE_LOOPBACK_SPEAKER_CALL_TX_48000_256;
static struct adie_codec_action_unit loopback_handset_call_rx_48KHz_osr256_actions[] =
	ADIE_LOOPBACK_HANDSET_CALL_RX_48000_256;
static struct adie_codec_action_unit loopback_handset_call_tx_48KHz_osr256_actions[] =
	ADIE_LOOPBACK_HANDSET_CALL_TX_48000_256;
static struct adie_codec_action_unit loopback_headset_call_rx_48KHz_osr256_actions[] =
 	ADIE_LOOPBACK_HEADSET_CALL_RX_48000_256;
static struct adie_codec_action_unit loopback_headset_call_tx_48KHz_osr256_actions[] =
 	ADIE_LOOPBACK_HEADSET_CALL_TX_48000_256;
...
/*------- DEFINITION OF GTALK VOIP CALL PAIRED DEVICES ------ */
...
//+for AMR Device
static struct adie_codec_hwsetting_entry handset_vcr_tx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = handset_vcr_tx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(handset_vcr_tx_48KHz_osr256_actions),
	}
};
static struct adie_codec_hwsetting_entry speaker_vcr_tx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = speaker_vcr_tx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(speaker_vcr_tx_48KHz_osr256_actions),
	}
};
static struct adie_codec_hwsetting_entry headset_vcr_tx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = headset_vcr_tx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(headset_vcr_tx_48KHz_osr256_actions),
	}
};
//-for AMR Device
...
static struct adie_codec_hwsetting_entry speaker_call_tx_settings[] = {
 ...
 //+for loopback Device
 static struct adie_codec_hwsetting_entry loopback_speaker_call_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = loopback_speaker_call_rx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(loopback_speaker_call_rx_48KHz_osr256_actions),
	}
};
static struct adie_codec_hwsetting_entry loopback_speaker_call_tx_settings[] = {

	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = loopback_speaker_call_tx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(loopback_speaker_call_tx_48KHz_osr256_actions),
	}
};
 static struct adie_codec_hwsetting_entry loopback_handset_call_rx_settings[] = {
	 {
		 .freq_plan = 48000,
		 .osr = 256,
		 .actions = loopback_handset_call_rx_48KHz_osr256_actions,
		 .action_sz = ARRAY_SIZE(loopback_handset_call_rx_48KHz_osr256_actions),
	 }
 };
 static struct adie_codec_hwsetting_entry loopback_handset_call_tx_settings[] = {

	 {
		 .freq_plan = 48000,
		 .osr = 256,
		 .actions = loopback_handset_call_tx_48KHz_osr256_actions,
		 .action_sz = ARRAY_SIZE(loopback_handset_call_tx_48KHz_osr256_actions),
	 }
 };
 static struct adie_codec_hwsetting_entry loopback_headset_call_rx_settings[] = {
	 {
		 .freq_plan = 48000,
		 .osr = 256,
		 .actions = loopback_headset_call_rx_48KHz_osr256_actions,
		 .action_sz = ARRAY_SIZE(loopback_headset_call_rx_48KHz_osr256_actions),
	 }
 };
 static struct adie_codec_hwsetting_entry loopback_headset_call_tx_settings[] = {

	 {
		 .freq_plan = 48000,
		 .osr = 256,
		 .actions = loopback_headset_call_tx_48KHz_osr256_actions,
		 .action_sz = ARRAY_SIZE(loopback_headset_call_tx_48KHz_osr256_actions),
	 }
 };
...
//+for AMR Device
static struct adie_codec_dev_profile handset_vcr_tx_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = handset_vcr_tx_settings,
	.setting_sz = ARRAY_SIZE(handset_vcr_tx_settings),
};
static struct adie_codec_dev_profile speaker_vcr_tx_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = speaker_vcr_tx_settings,
	.setting_sz = ARRAY_SIZE(speaker_vcr_tx_settings),
};
;
static struct adie_codec_dev_profile headset_vcr_tx_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = headset_vcr_tx_settings,
	.setting_sz = ARRAY_SIZE(headset_vcr_tx_settings),
};
//-for AMR Device
...
//+for loopback Device
static struct adie_codec_dev_profile loopback_speaker_call_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = loopback_speaker_call_rx_settings,
	.setting_sz = ARRAY_SIZE(loopback_speaker_call_rx_settings),
};
static struct adie_codec_dev_profile loopback_speaker_call_tx_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = loopback_speaker_call_tx_settings,
	.setting_sz = ARRAY_SIZE(loopback_speaker_call_tx_settings),
};
static struct adie_codec_dev_profile loopback_handset_call_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = loopback_handset_call_rx_settings,
	.setting_sz = ARRAY_SIZE(loopback_handset_call_rx_settings),
};
static struct adie_codec_dev_profile loopback_handset_call_tx_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = loopback_handset_call_tx_settings,
	.setting_sz = ARRAY_SIZE(loopback_handset_call_tx_settings),
};
static struct adie_codec_dev_profile loopback_headset_call_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = loopback_headset_call_rx_settings,
	.setting_sz = ARRAY_SIZE(loopback_headset_call_rx_settings),
};
static struct adie_codec_dev_profile loopback_headset_call_tx_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = loopback_headset_call_tx_settings,
	.setting_sz = ARRAY_SIZE(loopback_headset_call_tx_settings),
};
...
static struct snddev_icodec_data headset_tx_data = {
	...
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
#if defined(CONFIG_MACH_ANCORA) || defined(CONFIG_MACH_S8600)
...
//+for AMR Device
static enum hsed_controller handset_vcr_tx_pmctl_id[] = {PM_HSED_CONTROLLER_0};
static struct snddev_icodec_data handset_vcr_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "handset_vcr_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_TX,
	.profile = &handset_vcr_tx_profile,
	.channel_mode = 1,
	.pmctl_id = handset_vcr_tx_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(handset_tx_pmctl_id),
	.default_sample_rate = 48000,
	.pamp_on = msm_snddev_tx_route_config,
	.pamp_off = msm_snddev_tx_route_deconfig,
};
static enum hsed_controller spk_vcr_tx_pmctl_id[] = {PM_HSED_CONTROLLER_0};
static struct snddev_icodec_data speaker_vcr_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "speaker_vcr_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPEAKER_TX,
	.profile = &speaker_vcr_tx_profile,
	.channel_mode = 1,
	.pmctl_id = spk_vcr_tx_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(spk_pmctl_id),
	.default_sample_rate = 48000,
	.pamp_on = msm_snddev_tx_route_config,
	.pamp_off = msm_snddev_tx_route_deconfig,
};
static struct snddev_icodec_data headset_vcr_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "headset_vcr_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HEADSET_TX,
	.profile = &headset_vcr_tx_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct snddev_ecodec_data bt_sco_vcr_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_vcr_tx",
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_TX,
...
static struct snddev_icodec_data speaker_call_tx_data = {
 ...
 //+for loopback Device
 static struct snddev_icodec_data loopback_speaker_call_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "speaker_loopback_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPEAKER_LOOPBACK_CALL_RX,
	.profile = &loopback_speaker_call_rx_profile,
	.channel_mode = 2,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
	.pamp_on = &msm_snddev_poweramp_on_speaker_call,
...
//	.property = SIDE_TONE_MASK,
 ...
 static struct snddev_icodec_data loopback_speaker_call_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "speaker_loopback_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPEAKER_LOOPBACK_CALL_TX,
	.profile = &loopback_speaker_call_tx_profile,
	.channel_mode = 1,
	.pmctl_id = spk_call_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(spk_call_pmctl_id),
	.default_sample_rate = 48000,
 ...
 static struct snddev_icodec_data loopback_handset_call_rx_data = {
	 .capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	 .name = "handset_loopback_rx",
	 .copp_id = 0,
	 .acdb_id = ACDB_ID_HANDSET_LOOPBACK_CALL_RX,
	 .profile = &loopback_handset_call_rx_profile,
	 .channel_mode = 1,
	 .pmctl_id = NULL,
	 .pmctl_id_sz = 0,
	 .default_sample_rate = 48000,
 ...
 static struct snddev_icodec_data loopback_handset_call_tx_data = {
	 .capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	 .name = "handset_loopback_tx",
	 .copp_id = 0,
	 .acdb_id = ACDB_ID_HANDSET_LOOPBACK_CALL_TX,
	 .profile = &loopback_handset_call_tx_profile,
	 .channel_mode = 1,
	 .pmctl_id = handset_call_tx_pmctl_id,
	 .pmctl_id_sz = ARRAY_SIZE(handset_call_tx_pmctl_id),
	 .default_sample_rate = 48000,
 ...
 static struct snddev_icodec_data loopback_headset_call_rx_data = {
	 .capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	 .name = "headset_loopback_rx",
	 .copp_id = 0,
	 .acdb_id = ACDB_ID_HEADSET_LOOPBACK_CALL_RX,
	 .profile = &loopback_headset_call_rx_profile,
	 .channel_mode = 2,
	 .default_sample_rate = 48000,
 ...
 static struct snddev_icodec_data loopback_headset_call_tx_data = {
	 .capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	 .name = "headset_loopback_tx",
	 .copp_id = 0,
	 .acdb_id = ACDB_ID_HEADSET_LOOPBACK_CALL_TX,
	 .profile = &loopback_headset_call_tx_profile,
	 .channel_mode = 1,
	 .pmctl_id = NULL,
	 .pmctl_id_sz = 0,
	 .default_sample_rate = 48000,
...
static struct snddev_icodec_data headset_fmradio_rx_data = {
	...
	.channel_mode = 1,
	.default_sample_rate = 8000,
	.pamp_on = msm_snddev_poweramp_on_headset_fm,
	.pamp_off = msm_snddev_poweramp_off_headset_fm,
	//.dev_vol_type = SNDDEV_DEV_VOL_DIGITAL,
};
...
static struct snddev_icodec_data speaker_fmradio_rx_data = {
	...
	.channel_mode = 1,
	.default_sample_rate = 8000,
	.pamp_on = &msm_snddev_poweramp_on_speaker_fm,
	.pamp_off = &msm_snddev_poweramp_off_speaker_fm,
	//.dev_vol_type = SNDDEV_DEV_VOL_DIGITAL,
};
static struct snddev_icodec_data speaker_headset_fmradio_rx_data = {
	//.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_FM),
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "speaker_headset_fmradio_rx",
	.copp_id = 0,
...
static struct snddev_icodec_data headset_voip_tx_data = {
	...
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
#if defined(CONFIG_MACH_ANCORA) || defined(CONFIG_MACH_S8600) || defined(CONFIG_MACH_APACHE)
	.pamp_on = msm_snddev_tx_ear_route_config,
	.pamp_off = msm_snddev_tx_ear_route_deconfig,
#else	
	.pamp_on = msm_snddev_tx_route_config,
...
static struct snddev_ecodec_data bt_sco_mono_nrec_voip_rx_data = {
	...
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_NREC_VOIP_RX,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data bt_sco_mono_nrec_voip_tx_data = {
	...
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_NREC_VOIP_TX,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data bt_sco_mono_gtalk_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_mono_gtalk_rx",
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_VOIP_RX,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
...
static struct snddev_ecodec_data bt_sco_mono_gtalk_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_mono_gtalk_tx",
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_VOIP_TX,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
...
static struct snddev_ecodec_data bt_sco_mono_nrec_gtalk_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_mono_nrec_gtalk_rx",
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_NREC_VOIP_RX,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
...
static struct snddev_ecodec_data bt_sco_mono_nrec_gtalk_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_mono_nrec_gtalk_tx",
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_NREC_VOIP_TX,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
...
static struct snddev_ecodec_data bt_sco_stereo_gtalk_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_stereo_gtalk_rx",
	.copp_id = 0,
	.channel_mode = 1,
};

static struct snddev_ecodec_data bt_sco_stereo_gtalk_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_stereo_gtalk_tx",
	.copp_id = 0,
	.channel_mode = 1,
};

static struct snddev_ecodec_data bt_sco_stereo_nrec_gtalk_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_stereo_nrec_gtalk_rx",
	.copp_id = 0,
	.channel_mode = 1,
};
static struct snddev_ecodec_data bt_sco_stereo_nrec_gtalk_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_stereo_nrec_gtalk_tx",
	.copp_id = 0,
	.channel_mode = 1,
};
#endif
...
//+for AMR Device
static struct platform_device device_handset_vcr_tx = {
	.name = "snddev_icodec",
	.id = 11,
	.dev = { .platform_data = &handset_vcr_tx_data },
};
static struct platform_device device_speaker_vcr_tx = {
	.name = "snddev_icodec",
	.id = 13,
	.dev = { .platform_data = &speaker_vcr_tx_data },
};
static struct platform_device device_headset_vcr_tx = {
	.name = "snddev_icodec",
	.id = 15,
	.dev = { .platform_data = &headset_vcr_tx_data },
};
static struct platform_device device_bt_sco_vcr_tx = {
	.name = "msm_snddev_ecodec",
	.id = 17,
	.dev = { .platform_data = &bt_sco_vcr_tx_data },
};
//-for AMR Device
...
//+for loopback Device
static struct platform_device device_loopback_speaker_call_rx = {
	.name = "snddev_icodec",
	.id = 117,
	.dev = { .platform_data = &loopback_speaker_call_rx_data },
};
static struct platform_device device_loopback_speaker_call_tx = {
	.name = "snddev_icodec",
	.id = 118,
	.dev = { .platform_data = &loopback_speaker_call_tx_data },
};
static struct platform_device device_loopback_handset_call_rx = {
	.name = "snddev_icodec",
	.id = 119,
	.dev = { .platform_data = &loopback_handset_call_rx_data },
};
static struct platform_device device_loopback_handset_call_tx = {
	.name = "snddev_icodec",
	.id = 120,
	.dev = { .platform_data = &loopback_handset_call_tx_data },
};
static struct platform_device device_loopback_headset_call_rx = {
	.name = "snddev_icodec",
	.id = 121,
	.dev = { .platform_data = &loopback_headset_call_rx_data },
};
static struct platform_device device_loopback_headset_call_tx = {
	.name = "snddev_icodec",
	.id = 122,
	.dev = { .platform_data = &loopback_headset_call_tx_data },
};
...
static struct platform_device device_speaker_headset_fmradio_rx = {
	.name = "snddev_icodec",
	.id = 105,
	.dev = { .platform_data = &speaker_headset_fmradio_rx_data },
};
...
static struct platform_device device_bt_sco_mono_gtalk_rx = {
	.name = "msm_snddev_ecodec",
	.id = 146,
	.dev = { .platform_data = &bt_sco_mono_gtalk_rx_data },
};
static struct platform_device device_bt_sco_mono_gtalk_tx = {
	.name = "msm_snddev_ecodec",
	.id = 147,
	.dev = { .platform_data = &bt_sco_mono_gtalk_tx_data },
};
static struct platform_device device_bt_sco_mono_nrec_gtalk_rx = {
	.name = "msm_snddev_ecodec",
	.id = 148,
	.dev = { .platform_data = &bt_sco_mono_nrec_gtalk_rx_data },
};
static struct platform_device device_bt_sco_mono_nrec_gtalk_tx = {
	.name = "msm_snddev_ecodec",
	.id = 149,
	.dev = { .platform_data = &bt_sco_mono_nrec_gtalk_tx_data },
};
#if 0
static struct platform_device device_bt_sco_stereo_gtalk_rx = {
	.name = "msm_snddev_ecodec",
	//.id = 165,
	.dev = { .platform_data = &bt_sco_stereo_gtalk_rx_data },
};
static struct platform_device device_bt_sco_stereo_gtalk_tx = {
	.name = "msm_snddev_ecodec",
	//.id = 165,
	.dev = { .platform_data = &bt_sco_stereo_gtalk_tx_data },
};
static struct platform_device device_bt_sco_stereo_nrec_gtalk_rx = {
	.name = "msm_snddev_ecodec",
	//.id = 165,
	.dev = { .platform_data = &bt_sco_stereo_nrec_gtalk_rx_data },
};
static struct platform_device device_bt_sco_stereo_nrec_gtalk_tx = {
	.name = "msm_snddev_ecodec",
	//.id = 165,
	.dev = { .platform_data = &bt_sco_stereo_nrec_gtalk_tx_data },
};
#endif
#endif
...
#if defined(CONFIG_MACH_S8600) 
static struct platform_device *snd_devices_S8600[] __initdata = {
	&device_handset_rx,/*0*/
	&device_handset_tx,/*1*/
	&device_speaker_rx,/*2*/
	&device_speaker_tx,/*3*/
	...
	&device_bt_sco_rx,/*6*/
	&device_bt_sco_tx,/*7*/
	&device_bt_sco_nrec_rx,/*8*/
	&device_bt_sco_nrec_tx,/*9*/
	
	//+for AMR Device
	&device_handset_vcr_tx,/*11*/	
	&device_speaker_vcr_tx,/*13*/
	&device_headset_vcr_tx,/*15*/	
	&device_bt_sco_vcr_tx,/*17*/	
	//-for AMR Device

	&device_hdmi_stereo_rx,/*30*/
//	&device_aux_dock_rx,/*31*/
	&device_speaker_headset_rx,/*32*/
	&device_speaker_dock_rx,/*33*/
	&device_speaker_hdmi_rx,/*34*/

	&device_handset_call_rx,/*50*/
	&device_handset_call_tx,/*51*/
	&device_speaker_call_rx,/*52*/
	&device_speaker_call_tx,/*53*/

	//+for loopback Device
	&device_loopback_speaker_call_rx,/*117*/
	&device_loopback_speaker_call_tx,/*118*/
	&device_loopback_handset_call_rx,/*119*/
	&device_loopback_handset_call_tx,/*120*/
	&device_loopback_headset_call_rx,/*121*/
	&device_loopback_headset_call_tx,/*122*/
	//-for loopback Device

    
	&device_headset_call_rx,/*54*/
	&device_headset_call_tx,/*55*/
	&device_bt_sco_call_rx,/*56*/
	&device_bt_sco_call_tx,/*57*/
	&device_bt_sco_nrec_call_rx,/*58*/
	&device_bt_sco_nrec_call_tx,/*59*/
	
#if defined(CONFIG_MACH_S8600)
	&device_handset_voip_rx,/*60*/
	&device_handset_voip_tx,/*61*/
	&device_speaker_voip_rx,/*62*/
	&device_speaker_voip_tx,/*63*/
	&device_headset_voip_rx,/*64*/
	&device_headset_voip_tx,/*65*/
	&device_bt_sco_mono_voip_rx,/*66*/
	&device_bt_sco_mono_voip_tx,/*67*/
	&device_bt_sco_mono_nrec_voip_rx,/*68*/
	&device_bt_sco_mono_nrec_voip_tx,/*69*/
#endif

	&device_tty_headset_mono_call_rx,/*78*/
	&device_tty_headset_mono_call_tx,/*79*/
	
	//&device_dualmic_handset_call_tx,/*99*/
	
	&device_handset_fmradio_rx,/*100*/
	&device_headset_fmradio_rx,/*102*/
	&device_headset_fmradio_tx,/*103*/
	&device_speaker_fmradio_rx,/*104*/
	&device_speaker_headset_fmradio_rx,/*105*/
	
	&device_speaker_voice_dialer_tx,/*110*/
	&device_headset_voice_dialer_tx,/*111*/
	&device_bt_sco_voice_dialer_tx,/*112*/
	&device_bt_sco_nrec_voice_dialer_tx,/*113*/
	
	&device_speaker_voice_search_tx,/*115*/
	&device_headset_voice_search_tx,/*116*/
	
#if defined(CONFIG_MACH_S8600)
	&device_handset_gtalk_rx,//140
	&device_handset_gtalk_tx,//141
	&device_speaker_gtalk_rx,//142
	&device_speaker_gtalk_tx,//143
	&device_headset_gtalk_rx,//144
	&device_headset_gtalk_tx,//145 
	&device_bt_sco_mono_gtalk_rx,//146
	&device_bt_sco_mono_gtalk_tx,//147
	&device_bt_sco_mono_nrec_gtalk_rx,//148
	&device_bt_sco_mono_nrec_gtalk_tx,//149
#endif	
...
#elif CONFIG_MACH_S8600
   		platform_add_devices(snd_devices_S8600,
		ARRAY_SIZE(snd_devices_S8600));
	pr_err("%s: finished..\n", __func__);
